...

{
    ...
    var rectangle = new Rectangle(2, 11, 21, 100, 200);
...

    {
        ...
        var _Shape3 = function () {
            function _Shape3(x, y) {
                _classCallCheck(this, _Shape3);

                this._x = x;
                this._y = y;
            }

            _createClass(_Shape3, [{
                key: 'x',
                get: function get() {
                    return this._x;
                },
        ...
        var _Rectangle = function (_aggregation) {
            _inherits(_Rectangle, _aggregation);

            function _Rectangle() {
                _classCallCheck(this, _Rectangle);

                return _possibleConstructorReturn(this, (_Rectangle.__proto__ || Object.getPrototypeOf(_Rectangle)).apply(this, arguments));
            }

            return _Rectangle;
        }(aggregation(_Shape3, Colored, ZCoord));

        var rect = new _Rectangle(7, 42);
        rect.z = 1000;
        rect.color = 'red';
...

    {
        var _Shape4 = function () {
            function _Shape4(id, x, y) {
                _classCallCheck(this, _Shape4);
        ...
        var _Rectangle2 = function (_Shape5) {
            _inherits(_Rectangle2, _Shape5);

            function _Rectangle2(id, x, y, width, height) {
                _classCallCheck(this, _Rectangle2);

                return _possibleConstructorReturn(this, (_Rectangle2.__proto__ || Object.getPrototypeOf(_Rectangle2)).call(this, id, x, y));
            }

            _createClass(_Rectangle2, [{
                key: 'toString',
                value: function toString() {
                    return 'Rectangle > ' + _get(_Rectangle2.prototype.__proto__ || Object.getPrototypeOf(_Rectangle2.prototype), 'toString', this).call(this);
                }
            }]);
        ...
        var _Circle = function (_Shape6) {
            _inherits(_Circle, _Shape6);

            function _Circle(id, x, y, radius) {
                _classCallCheck(this, _Circle);

                return _possibleConstructorReturn(this, (_Circle.__proto__ || Object.getPrototypeOf(_Circle)).call(this, id, x, y));
            }

            _createClass(_Circle, [{
                key: 'toString',
                value: function toString() {
                    return 'Circle > ' + _get(_Circle.prototype.__proto__ || Object.getPrototypeOf(_Circle.prototype), 'toString', this).call(this);
                }
            }]);
        ...
        var _shape = new _Shape4(1, 10, 20);
        console.log(_shape.toString());
        var _rectangle = new _Rectangle2(2, 20, 30);
        console.log(_rectangle.toString());
        var _circle = new _Circle(3, 30, 40);
...

    {
        var _Rectangle3 = function (_Shape7) {
            _inherits(_Rectangle3, _Shape7);

            function _Rectangle3(id, x, y, width, height) {
                _classCallCheck(this, _Rectangle3);

                var _this7 = _possibleConstructorReturn(this, (_Rectangle3.__proto__ || Object.getPrototypeOf(_Rectangle3)).call(this, id, x, y));
            ...
            _createClass(_Rectangle3, null, [{
                key: 'defaultRectangle',
                value: function defaultRectangle() {
                    return new _Rectangle3('default', 2, 2, 100, 100);
                }
            }]);
        ...
        var _Circle2 = function (_Shape8) {
            _inherits(_Circle2, _Shape8);

            function _Circle2(id, x, y, radius) {
                _classCallCheck(this, _Circle2);

                var _this8 = _possibleConstructorReturn(this, (_Circle2.__proto__ || Object.getPrototypeOf(_Circle2)).call(this, id, x, y));

                _this8.radius = radius;
                return _this8;
            }

            _createClass(_Circle2, null, [{
                key: 'defaultCircle',
                value: function defaultCircle() {
                    return new _Circle2('default', 4, 4, 100);
                }
            }]);
        ...
        var _rectangle2 = _Rectangle3.defaultRectangle();
        console.log('Rectangle data:', JSON.stringify(_rectangle2));
        var _circle2 = _Circle2.defaultCircle();
...

    {
        var _Rectangle4 = function () {
            function _Rectangle4(width, height) {
                _classCallCheck(this, _Rectangle4);

                this._width = width;
                this._height = height;
            }

            _createClass(_Rectangle4, [{
                key: 'width',
...

{
    ...
    var obj3 = {
        ...
        quux2: regeneratorRuntime.mark(function quux2(x, y) {
            return regeneratorRuntime.wrap(function quux2$(_context) {
                while (1) {
